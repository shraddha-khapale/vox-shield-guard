...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NIVOX Voice Defense" },
      { name: "description", content: "Real-time voice authenticity and deepfake detection for security and fraud analysts." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "NIVOX Voice Defense" },
      { property: "og:description", content: "Real-time voice authenticity and deepfake detection for security and fraud analysts." },
